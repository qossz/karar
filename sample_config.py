...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/redaiq90/k69rr"
    )
    ...
    PMPERMIT_TEXT_k69rr = os.environ.get("PMPERMIT_TEXT_k69rr", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in k69rr
