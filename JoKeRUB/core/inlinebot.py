...
def main_menu():
    text = f"**- [سـورس الجوكر](https://t.me/isfati0)\
        \n المسـاعد\
        \n\
        \n◽ الجوكر لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("l313l"):
            buttons = [
                (
                    ...
                    Button.url(" JoKeRUB UsᴇʀBoᴛ", "https://t.me/isfati0"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("قنـاة السـورس ⚒️", "https://t.me/isfati0"),
                Button.url(
                    "كـروب المـساعدة 📬",
                    "https://t.me/isfati01",
                ),
